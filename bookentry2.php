EditPad Pro Difference File  --  http://www.editpadpro.com/
2
bookentry2.php compared with bookmod.php
C:\Users\draines\Downloads\books\bookentry2.php
C:\Users\draines\Downloads\books\bookmod.php
564
...
=    <meta name="description" content="Entry form for books for Darrel Raines." />
...
=      $a_bookid = (INPUT_GET, 'bookid', FILTER_VALIDATE_INT);
=    } else {
=      $a_bookid = 0;
=    }
=    if ($a_bookid == 0) {
...
=        $("#currentCover").html("<img src='../images/ajax_loader_1.gif' alt='New Cover' />");
...
=    $("#exRow1").style.display = "table-row";
=    $("#exRow2").style.display = "table-row";
=    $("#exRow3").style.display = "table-row";
=    $("#exRow4").style.display = "table-row";
=    $.getJSON("get_isbndb_info.php", {isbn: $f_books_isbn, response: "json"}, compare_isbn_info);
=    $.ajax({url: "get_book_cover.php", data: {isbn: $f_books_isbn}, success: compare_book_cover});
=  }
=
